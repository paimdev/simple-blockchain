...
class Blockchain(object):
    ...
    def register_node(self, address):
        """
        Add a new node to the full list of nodes
    ...
    def resolve_conflicts(self):
        """
        This is our Consensus Algo, it resolves conflicts by
        replacing our cahin with the longest one in the network.
    ...
    # We're only lookiing for chains longer than ours
